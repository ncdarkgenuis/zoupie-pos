...
// Serve static frontend files cleanly from the root directory
    ...
    try {
        for (const item of items) {
            ...
            if (existing) {
                ...
                // If no expiry date is provided, fallback to a far-future placeholder date string format
                const validExpiryDate = item.expiry_date || "2099-12-31";
