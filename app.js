...
function toggleRestockMode(mode) {
    ...
    if (mode === 'new') {
        ...
        if (pricingGroup) pricingGroup.style.display = 'grid';
    } else {
        existingGroup.style.display = 'block';
        newGroup.style.display = 'none';
        if (pricingGroup) pricingGroup.style.display = 'none';
    }
}
...
async function submitStockAdjustment() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            if(document.getElementById('stock-new-name')) document.getElementById('stock-new-name').value = '';
            if(document.getElementById('stock-cost-price')) document.getElementById('stock-cost-price').value = '';
            if(document.getElementById('stock-sale-price')) document.getElementById('stock-sale-price').value = '';
            
            loadInventorySelects();
            loadInventory();
        } else { 
            alert("Failed to save changes. Make sure your Render environment variables match your Supabase DB setup!"); 
        }
